...
<?php if(is_category($kg_news) ): ?>

	<?php 
	$sub_news=explode('_',$kg_news);


	factory_get_byslug_wpmu($sub_news[1],2,'teacher') ?>
...
<div class="page_navi"><?php par_pagenavi($wp_query->max_num_pages); ?></div>
