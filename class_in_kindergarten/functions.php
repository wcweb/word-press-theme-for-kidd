...
function factory_get_byslug_wpmu($slug,$how_many){
	global $wpdb;


$how_many= $how_many != null ? " LIMIT 0,".$how_many." " : " ";
...
foreach ($id_cat as $ksc => $volsc)
{
     ...
     $most_cat = $wpdb->get_results("SELECT  * from ian_".$volsc."_terms where slug = '".$slug."'" .$how_many);
