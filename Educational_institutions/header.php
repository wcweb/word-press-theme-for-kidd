...
<script type="text/javascript" src="<?php bloginfo("template_directory") ?>/fancybox/jquery.mousewheel-3.0.4.pack.js"></script>
    ...
    <link rel="stylesheet" href="<?php bloginfo("template_directory") ?>/css/themes/pascal/pascal.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php bloginfo("template_directory") ?>/css/themes/orman/orman.css" type="text/css" media="screen" />
...
<div id="wrapper" class="hfeed">
		...
		<div id="masthead">
			...
			<div id="branding" role="banner" >
				...
				<<?php echo $heading_tag; ?> id="site-title">
					<span>
						<a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php bloginfo("template_directory") ?>/images/logo.gif"/><p><?php bloginfo( 'name' ); ?></p></a>
					</span>
	...
	<div id="main" <?php if(is_front_page())  echo "class='main_index'" ; ?> >
